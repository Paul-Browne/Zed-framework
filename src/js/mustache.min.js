!(function(e, t) {
  ...
  (O.prototype.eos = function() {
    ...
    (s.prototype.lookup = function(e) {
      ...
      if (i.hasOwnProperty(e)) t = i[e];
        ...
        for (var o, s, a, u = this, c = !1; u; ) {
          if (0 < e.indexOf("."))
            for (
              o = u.view, s = e.split("."), a = 0;
              null != o && a < s.length;
      ...
      return p(t) && (t = t.call(this.view)), t;
    }),
        ...
        null == i &&
          (i = n[r] = (function(e, t) {
            ...
            var n,
              ...
              c = !1;
            function p() {
              if (u && !c) for (; a.length; ) delete s[a.pop()];
              else a = [];
              c = u = !1;
            }
            function l(e) {
              if (
                ("string" == typeof e && (e = e.split(j, 2)),
                !m(e) || 2 !== e.length)
              )
                throw new Error("Invalid tags: " + e);
              (n = new RegExp(E(e[0]) + "\\s*")),
                (r = new RegExp("\\s*" + E(e[1]))),
                (i = new RegExp("\\s*" + E("}" + e[1])));
            }
            l(t || k.tags);
            for (var h, f, d, g, v, w, y = new O(e); !y.eos(); ) {
              if (((h = y.pos), (d = y.scanUntil(n))))
                for (var x = 0, b = d.length; x < b; ++x)
                  U((g = d.charAt(x))) ? a.push(s.length) : (c = !0),
                    s.push(["text", g, h, h + 1]),
                    (h += 1),
                    "\n" === g && p();
              if (!y.scan(n)) break;
              if (
                ...
                y.scan(T),
                "=" === f
                  ? ((d = y.scanUntil(S)), y.scan(S), y.scanUntil(r))
                  : "{" === f
                  ? ((d = y.scanUntil(i)), y.scan(V), y.scanUntil(r), (f = "&"))
                  : (d = y.scanUntil(r)),
                !y.scan(r))
              )
                throw new Error("Unclosed tag at " + y.pos);
              if (((v = [f, d, h, y.pos]), s.push(v), "#" === f || "^" === f))
                o.push(v);
              else if ("/" === f) {
                if (!(w = o.pop()))
                  throw new Error('Unopened section "' + d + '" at ' + h);
                if (w[1] !== d)
                  throw new Error('Unclosed section "' + w[1] + '" at ' + h);
              } else
                "name" === f || "{" === f || "&" === f
                  ? (c = !0)
                  : "=" === f && l(d);
    ...
    (e.prototype.renderTokens = function(e, t, n, r, i) {
      ...
      if (s) {
        if (m(s))
          for (var a = 0, u = s.length; a < u; ++a)
            o += this.renderTokens(e[4], t.push(s[a]), n, r);
        else if (
          "object" == typeof s ||
          "string" == typeof s ||
          "number" == typeof s
        )
          o += this.renderTokens(e[4], t.push(s), n, r);
        else if (p(s)) {
          if ("string" != typeof r)
            throw new Error(
          ...
          null !=
            (s = s.call(t.view, r.slice(e[3], e[5]), function(e) {
    ...
    (e.prototype.renderPartial = function(e, t, n, r) {
      if (n) {
        var i = p(n) ? n(e[1]) : n[e[1]];
        return null != i
          ? this.renderTokens(this.parse(i, r), t, n, i)
          : void 0;
      }
    }),
  ...
  return (
    ...
    (k.render = function(e, t, n, r) {
      ...
      return o.render(e, t, n, r);
    }),
    (k.to_html = function(e, t, n, r) {
      var i = k.render(e, t, n);
      if (!p(r)) return i;
      r(i);
    }),
    (k.escape = function(e) {
